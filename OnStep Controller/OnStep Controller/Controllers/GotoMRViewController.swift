    ...
    func socket(_ sock: GCDAsyncSocket, didRead data: Data, withTag tag: Int) {
        ...
        case 3:
            ...
            if getText! == "1" {
                ...
                let banner = StatusBarNotificationBanner(title: "Fastest command failed.", style: .warning)
                banner.show()
            }
        case 4:
            ...
            if getText! == "1" {
                ...
                let banner = StatusBarNotificationBanner(title: "Faster command failed.", style: .warning)
                banner.show()
            }
        case 5:
            ...
            if getText! == "1" {
                ...
                let banner = StatusBarNotificationBanner(title: "Default command failed.", style: .warning)
                banner.show()
            }
        case 6:
            ...
            if getText! == "1" {
                ...
                let banner = StatusBarNotificationBanner(title: "Slower command failed.", style: .warning)
                banner.show()
            }
        case 7:
            ...
            if getText! == "1" {
                ...
                let banner = StatusBarNotificationBanner(title: "Slowest command failed.", style: .warning)
                banner.show()
            }
        default:
            print("def")
